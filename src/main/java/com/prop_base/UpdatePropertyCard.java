...
//-Editable property fields
    ...
    public UpdatePropertyCard() 
    {
        ...
        accountField = StyleHelper.addLabeledField(this, "Account Number:", row++);
    ...
    //-Adds the form fields
        ...
        {
            fields[i] = StyleHelper.addLabeledField(this, labels[i] + ":", row++);                  //-Calls a method that creates a label and field
